    ...
    <div class="container-fluid">
      ...
      <div class="row">
                      ...
                      <ul class="d-flex align-items-center gap-3 mb-0">
                        <li class="d-flex">
                          <div class="text-primary d-flex align-items-center gap-2 fs-3">
                            <iconify-icon icon="ri:circle-fill" class="fs-2"></iconify-icon>Ample
                          </div>
                        </li>
                        <li class="d-flex ">
                          <div class="text-secondary d-flex align-items-center gap-2 fs-3">
                            <iconify-icon icon="ri:circle-fill" class="fs-2"></iconify-icon>Pixel
                          </div>
                        </li>
                      </ul>
                    </div>
          ...
          <div class="card blog-widget w-100">
            <div class="card-body p-2">
              <div class="blog-image">
                <img src="{{ asset('assets/images/backgrounds/blog-bg.jpg') }}" height="273" alt="img" class="w-100 rounded" />
              </div>
              <div class="p-9">
                <div class="
                badge badge-pill
            ...
            <div class="card-body bg-purple">
              <div class="hstack gap-6 mb-7">
                ...
                <div>
                  ...
                  <p class="card-subtitle text-white opacity-70">March 2023</p>
                </div>
              </div>
        ...
        <div class="col-lg-4">
          <div class="card ">
            <div class="card-body p-2">
              <div class="rounded bg-primary-subtle hstack justify-content-between px-9 py-7">
                <h4 class="mb-0">New Delhi</h4>
                <p class="mb-0">Sunday 15 march</p>
              </div>
              <div class="hstack gap-6 px-9 pt-4 pb-3">
                <div class="bg-primary-subtle round-48 rounded-circle d-flex align-items-center justify-content-center">
                  <iconify-icon icon="solar:cloud-sun-2-linear" class="fs-7 icon-center text-primary"></iconify-icon>
                </div>
                <div class="me-lg-4">
                  <h3 class="text-primary mb-0 ">32 °C</h3>
                  <p class="mb-0">Sunny Rainy </p>
                </div>
                <div>
        ...
        <div class="col-lg-5 col-xl-4">
          ...
          <div class="card">
            <div class="card-body p-2">
              <img class="card-img-top w-100 profile-bg-height rounded overflow-hidden" src="{{ asset('assets/images/backgrounds/profile-bg.jpg') }}" height="111" alt="Card image cap" />
              <div class="card-body little-profile text-center p-9">
                <div class="pro-img">
                  <img src="{{ asset('assets/images/profile/user-2.jpg') }}" alt="user" class="rounded-circle shadow-sm" width="112" />
                </div>
              ...
              <div class="message-widget contact-widget position-relative">
                ...
                <a href="javascript:void(0)" class="py-4 hstack px-7 gap-3">
                  <div class="user-img position-relative">
                    <img src="{{ asset('assets/images/profile/user-2.jpg') }}" alt="user" class="rounded-circle w-100" />
                    <span class="
                        profile-status
                        pull-right
                        d-inline-block
                ...
                <a href="javascript:void(0)" class="py-4 hstack px-7 gap-3">
                  <div class="user-img position-relative">
                    <img src="{{ asset('assets/images/profile/user-6.jpg') }}" alt="user" class="rounded-circle w-100" />
                    <span class="
                        profile-status
                        pull-right
                        d-inline-block
                ...
                <a href="javascript:void(0)" class="py-4 pb-7 hstack px-7 gap-8">
                  <div class="user-img position-relative">
                    <img src="{{ asset('assets/images/profile/user-3.jpg') }}" alt="user" class="rounded-circle w-100" />
                    <span class="
                        profile-status
                        pull-right
                        d-inline-block
                ...
                <div class="tab-pane active" id="home" role="tabpanel">
                  <div class="profiletimeline position-relative">
                        ...
                        <div>
                          ...
                          <div class="row gx-9">
                            <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                              <img src="{{ asset('assets/images/blog/blog-img1.jpg') }}" alt="user" class="rounded-1 w-100" height="80" />
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                              <img src="{{ asset('assets/images/blog/blog-img2.jpg') }}" alt="user" class="rounded-1 w-100" height="80" />
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                              <img src="{{ asset('assets/images/blog/blog-img3.jpg') }}" alt="user" class="rounded-1 w-100" height="80" />
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                              <img src="{{ asset('assets/images/blog/blog-img4.jpg') }}" alt="user" class="rounded-1 w-100" height="80" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="sl-item my-4 mb-0 pt-3">
                      <div class="sl-left float-left me-4">
                        <img src="{{ asset('assets/images/profile/user-6.jpg') }}" alt="user" class="rounded-circle" />
                      </div>
                      <div class="sl-right w-100">
                        <div>
                          <div class="d-md-flex align-items-center justify-content-between gap-6 mb-6">
                          ...
                          <div class="row gx-9 mb-9">
                            <div class="col-lg-5">
                              <div class="hstack gap-3 border rounded-2 px-7 py-9">
                                <img src="{{ asset('assets/images/svgs/icon-zip.svg') }}" alt="user" class="img-fluid flex-shrink-0" />
                                <div>
                                  <h5>Payments.zip</h5>
                            ...
                            <div class="col-lg-5">
                              <div class="hstack gap-3 border rounded-2 px-7 py-9">
                                <img src="{{ asset('assets/images/svgs/icon-figma2.svg') }}" alt="user" class="img-fluid flex-shrink-0" />
                                <div>
                                  <h5>Payments.zip</h5>
                                  <p class="mb-0 fs-3">150kb</p>
                                </div>
