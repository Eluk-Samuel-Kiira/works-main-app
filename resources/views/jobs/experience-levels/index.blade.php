@extends('layouts.app')
@section('title', 'Experience Levels - Stardena Works')
        ...
        <div class="font-weight-medium shadow-none position-relative overflow-hidden mb-7">
            <div class="card-body px-0">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="font-weight-medium mb-0">Experience Levels</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item text-muted" aria-current="page">Experience Levels</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
                        <button class="btn btn-primary d-flex align-items-center gap-2" onclick="openCreateModal()">
                            <i class="ti ti-plus fs-4"></i> Add Experience Level
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title mb-0">All Experience Levels</h4>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="ti ti-award me-2"></i><span id="viewModalTitle">Experience Level Details</span></h5>
...
<div class="modal fade" id="formModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalTitle"><i class="ti ti-plus me-2"></i>Add Experience Level</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
                ...
                <form id="itemForm" onsubmit="return false;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="formName" required placeholder="e.g. Mid-Level">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Min Years</label>
                            <input type="number" class="form-control" id="formMinYears" min="0" placeholder="e.g. 2">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Max Years</label>
                            <input type="number" class="form-control" id="formMaxYears" min="0" placeholder="e.g. 5">
                        </div>
                        <div class="col-12">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title"><i class="ti ti-trash me-2"></i>Delete Experience Level</h5>
...
@include('jobs.experience-levels.index-js')
@endsection
