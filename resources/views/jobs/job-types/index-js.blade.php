<script>
    ...
    const API_BASE   = '/api/v1/job-types';
    ...
    async function loadItems(page = 1) {
        ...
        try {
            ...
            tbody.innerHTML = `<tr><td colspan="6" class="text-center text-danger py-3"><i class="ti ti-alert-circle me-1"></i>Failed to load job types.</td></tr>`;
        }
    }
    ...
    function renderTable(items) {
        ...
        if (!items || items.length === 0) {
            tbody.innerHTML = `<tr><td colspan="6" class="text-center py-4 text-muted">No job types found.</td></tr>`;
            return;
        }
    ...
    function openCreateModal() {
        currentId = null;
        document.getElementById('formModalTitle').innerHTML = '<i class="ti ti-plus me-2"></i>Add Job Type';
    ...
    async function openEditModal(id) {
        currentId = id;
        document.getElementById('formModalTitle').innerHTML = '<i class="ti ti-pencil me-2"></i>Edit Job Type';
    ...
    async function submitSave() {
        ...
        try {
            if (currentId) {
                ...
                toast('Job type updated successfully.');
            } else {
                await apiFetch(API_BASE, { method: 'POST', body: JSON.stringify(payload) });
                toast('Job type created successfully.');
            }
    ...
    async function confirmDelete() {
        ...
        try {
            ...
            toast('Job type deleted successfully.');
